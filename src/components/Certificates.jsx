...
const certificates = [
  {
    ...
    description: 'Completed a career readiness program covering communication, workplace skills, and AI fundamentals.',
  ...
  },
  {
    ...
    description: 'Built practical knowledge of analytics reporting, traffic analysis, and interpreting user behavior data.',
  ...
  },
  {
    ...
    description: 'Learned app publishing, optimization, and performance practices for products on the Google Play ecosystem.',
  ...
  },
  {
    ...
    description: 'Covered front-end fundamentals and core web development concepts used to build responsive websites.',
